# Session 798911424 registration pilot — initial fit checkpoint
...
Session 798911424 was selected algorithmically from the four
sessions displayed in the registration-readiness PDF: it has complete CCF
coverage for all 275 trusted units and the
largest usable set of named visual areas. Those units occupy only
6 independent probe penetrations, so the fit
