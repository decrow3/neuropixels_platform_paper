...
Median RF-size correlation gain: **+0.506**.
Median azimuth/elevation profile widths: **1.5° / 2.5°** (smaller means better identified).
Sessions at a ±20° bound: **8/31**.
Independent target-unit halves reproduce azimuth offsets at **rho = +0.209** and elevation offsets at **rho = +0.128**.
Median absolute half-to-half differences are **10.7°** azimuth and **6.7°** elevation.
