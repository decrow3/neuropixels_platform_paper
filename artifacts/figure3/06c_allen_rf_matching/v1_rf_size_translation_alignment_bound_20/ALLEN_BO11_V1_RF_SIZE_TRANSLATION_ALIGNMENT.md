...
Median RF-size correlation gain: **+0.524**.
Median azimuth/elevation profile widths: **2.0° / 2.0°** (smaller means better identified).
Sessions at a ±20° bound: **15/31**.
Independent target-unit halves reproduce azimuth offsets at **rho = +0.305** and elevation offsets at **rho = -0.062**.
Median absolute half-to-half differences are **12.0°** azimuth and **9.6°** elevation.
