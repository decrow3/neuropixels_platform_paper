...
| **log10 F1/F0** | Within-V1 probes | 4 | 32 | 0.022 | -0.080 | [-0.094, +0.261] | — | — | — |
| | Post-V1 areas | 6 | 264 | 0.024 | 0.005 | [-0.009, +0.072] | +0.085 | [-0.241, +0.130] | 0.401 |
...
**log10 F1/F0** — between-group structure is reported for the selected grating metric. interpret this row together with its bootstrap interval.
ω²_probes = -0.080 [-0.094, +0.261], ω²_areas = 0.005 [-0.009, +0.072], Δω² = +0.085 [-0.241, +0.130], P(Δ≤0) = 0.401.
...
- **F1/F0 population offset**: After QC, new-session V1 median F1/F0 ≈ 0.79 vs
