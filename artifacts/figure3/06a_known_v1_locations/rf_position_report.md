...
Response-property checkpoint: `mod_idx_dg`, `pooled flashes`, population `common_qc`. TTFS is raw relative to NWB start_time.
...
| --- | --- | ---: | ---: |
| time_to_first_spike_fl | rf_center_x_deg | 32 | -0.167 |
| time_to_first_spike_fl | rf_center_y_deg | 32 | -0.080 |
| mod_idx_dg | rf_center_x_deg | 32 | 0.243 |
| mod_idx_dg | rf_center_y_deg | 32 | 0.155 |
| timescale_ac | rf_center_x_deg | 32 | -0.054 |
| timescale_ac | rf_center_y_deg | 32 | -0.090 |
