...
*Fourth column*: pairwise significance matrix (Mann–Whitney U, Benjamini–Hochberg FDR corrected).
Modulation index uses AllenSDK's Welch-spectrum z-score at the preferred full orientation × TF × SF condition.
MouseV2 flash metrics use the `pooled` presentation set; Allen uses its released pooled-flash values.
...
| **Timescale (ms)** | Within-V1 probes | 4 | 32 | 0.127 | 0.033 | [-0.086, +0.410] | — | — | — |
| | Post-V1 areas | 6 | 218 | 0.192 | 0.172 | [+0.112, +0.275] | +0.140 | [-0.230, +0.304] | 0.252 |
...
ω²_probes = 0.033 [-0.086, +0.410], ω²_areas = 0.172 [+0.112, +0.275], Δω² = +0.140 [-0.230, +0.304], P(Δ≤0) = 0.252.
