...
MouseV2 flash metrics use the `dark` presentation set; Allen uses its released pooled-flash values.
...
|--------|---------|---|-------------|----|----|-------------|-------------------|--------------|--------|
| **TTFS (ms)** | Within-V1 probes | 4 | 32 | 0.257 | 0.172 | [+0.008, +0.537] | — | — | — |
| | Post-V1 areas | 6 | 258 | 0.142 | 0.125 | [+0.072, +0.224] | -0.047 | [-0.407, +0.145] | 0.763 |
...
| **Timescale (ms)** | Within-V1 probes | 4 | 32 | 0.217 | 0.129 | [-0.038, +0.522] | — | — | — |
| | Post-V1 areas | 6 | 218 | 0.192 | 0.172 | [+0.112, +0.275] | +0.043 | [-0.340, +0.247] | 0.521 |
...
ω²_probes = 0.172 [+0.008, +0.537], ω²_areas = 0.125 [+0.072, +0.224], Δω² = -0.047 [-0.407, +0.145], P(Δ≤0) = 0.763.
...
ω²_probes = 0.129 [-0.038, +0.522], ω²_areas = 0.172 [+0.112, +0.275], Δω² = +0.043 [-0.340, +0.247], P(Δ≤0) = 0.521.
