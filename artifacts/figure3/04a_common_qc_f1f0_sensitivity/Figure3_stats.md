...
| **log10 F1/F0** | Within-V1 probes | 4 | 32 | 0.022 | -0.080 | [-0.093, +0.246] | — | — | — |
| | Post-V1 areas | 6 | 262 | 0.025 | 0.006 | [-0.009, +0.077] | +0.086 | [-0.223, +0.135] | 0.407 |
...
ω²_probes = -0.080 [-0.093, +0.246], ω²_areas = 0.006 [-0.009, +0.077], Δω² = +0.086 [-0.223, +0.135], P(Δ≤0) = 0.407.
...
- **F1/F0 population offset**: After QC, new-session V1 median F1/F0 ≈ 0.79 vs
  Allen V1 median ≈ 0.66. Residual offset may reflect remaining population
