...
Response-property checkpoint: `mod_idx_dg`, `bright flashes`, population `common_qc`. TTFS is raw relative to NWB start_time.
...
| --- | --- | ---: | ---: |
| time_to_first_spike_fl | rf_center_x_deg | 32 | -0.400 |
| time_to_first_spike_fl | rf_center_y_deg | 32 | -0.260 |
| mod_idx_dg | rf_center_x_deg | 32 | 0.243 |
| mod_idx_dg | rf_center_y_deg | 32 | 0.155 |
| timescale_ac | rf_center_x_deg | 32 | -0.065 |
| timescale_ac | rf_center_y_deg | 32 | -0.266 |
