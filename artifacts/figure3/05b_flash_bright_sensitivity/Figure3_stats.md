...
MouseV2 flash metrics use the `bright` presentation set; Allen uses its released pooled-flash values.
...
|--------|---------|---|-------------|----|----|-------------|-------------------|--------------|--------|
| **TTFS (ms)** | Within-V1 probes | 4 | 32 | 0.296 | 0.215 | [+0.077, +0.573] | — | — | — |
| | Post-V1 areas | 6 | 258 | 0.142 | 0.125 | [+0.072, +0.224] | -0.090 | [-0.445, +0.075] | 0.891 |
...
| **Timescale (ms)** | Within-V1 probes | 4 | 32 | 0.109 | 0.013 | [-0.083, +0.428] | — | — | — |
| | Post-V1 areas | 6 | 218 | 0.192 | 0.172 | [+0.112, +0.275] | +0.160 | [-0.247, +0.302] | 0.276 |
...
ω²_probes = 0.215 [+0.077, +0.573], ω²_areas = 0.125 [+0.072, +0.224], Δω² = -0.090 [-0.445, +0.075], P(Δ≤0) = 0.891.
...
ω²_probes = 0.013 [-0.083, +0.428], ω²_areas = 0.172 [+0.112, +0.275], Δω² = +0.160 [-0.247, +0.302], P(Δ≤0) = 0.276.
