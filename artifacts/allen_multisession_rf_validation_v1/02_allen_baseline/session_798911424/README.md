...
In V1, median half-maximum area changes from 2627 to 426 deg2, and Spearman rho between log2 area and distance from the nearest sampled edge changes from -0.28 to +0.02.
In pooled HVAs, median half-maximum area changes from 8361 to 808 deg2. HVA support in this session is strongly boundary concentrated, so its spatial surface should be read within the effective-sample contours.
